...
class GomokuGUI:
    ...
    def __init__(self, root, board_size=10, cell_size=50):
        ...
        # for normal mode max-depth = 2 * these options aren't available now. you create these options  . also add another option to pass and play
        # for hard mode max-depth = 3
        # for super hard mode max-depth = 7
